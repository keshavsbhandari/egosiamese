...
from Classifier.mc import LTNClassifier as MClassifier
from Classifier.sc import LTNClassifier as SClassifier

from Extras.loadconfigs import (MC_PATH,
                                SC_PATH,
                                NUM_CLASSES)

class CatClassifier(pl.LightningModule):
    def __init__(self,
                 lr = 1e-3,
        ...
        self.model = Fuser(spatial_classifier = SClassifier.load_from_checkpoint(SC_PATH).model,
                           motion_classifier = MClassifier.load_from_checkpoint(MC_PATH).model,
